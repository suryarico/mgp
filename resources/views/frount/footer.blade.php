                 ...
                 <div class="swiper-wrapper">
                   <div class="swiper-slide">
                     <a href="#" class="single-img">
                       <img class="img-full" src="{{ asset('public/assets/images/product/large-size/1-1-570x633.jpg')}}" alt="Product Image">
                     </a>
                   </div>
                   <div class="swiper-slide">
                     <a href="#" class="single-img">
                       <img class="img-full" src="{{ asset('public/assets/images/product/large-size/1-2-570x633.jpg')}}" alt="Product Image">
                     </a>
                   </div>
                   <div class="swiper-slide">
                     <a href="#" class="single-img">
                       <img class="img-full" src="{{ asset('public/assets/images/product/large-size/1-3-570x633.jpg')}}" alt="Product Image">
                     </a>
                   </div>
                   <div class="swiper-slide">
                     <a href="#" class="single-img">
                       <img class="img-full" src="{{ asset('public/assets/images/product/large-size/1-4-570x633.jpg')}}" alt="Product Image">
                     </a>
                   </div>
                 </div>
               </div>
             ...
             <div class="single-product-content">
               ...
               <ul class="quantity-with-btn">
                 ...
                 <li class="add-to-cart">
                   <a class="btn btn-custom-size lg-size btn-pronia-primary" href="#">Add to
                     cart</a>
                 </li>
