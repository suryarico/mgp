    ...
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Add Banner <small></small></h2>
                        <div class="clearfix"></div>
                    </div>
                    <div class="x_content">
                        <br />
                        <form role="form" id="quickForm" action="{{route('admin.banners.create')}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group{{ $errors->has('title_pre_text') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-6">
                                        <input id="title_pre_text" type="text" class="form-control" name="title_pre_text" value="{{ old('title_pre_text') }}" required autofocus placeholder="Enter title pre text">
                                ...
                                <div class="form-group{{ $errors->has('title_post_text') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-6">
                                        <input id="title_post_text" type="text" class="form-control" name="title_post_text" value="{{ old('title_post_text') }}" required autofocus placeholder="Enter title post text">
                                ...
                                <div class="form-group{{ $errors->has('banner_link') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-6">
                                        <input id="banner_link" type="text" class="form-control" name="banner_link" value="{{ old('banner_link') }}" required autofocus placeholder="Enter Banner Link">
                                ...
                                <div class="form-group{{ $errors->has('banner_image') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-6">
                                        <input id="banner_image" type="file" class="form-control" name="banner_image" value="{{ old('banner_image') }}" required autofocus>
